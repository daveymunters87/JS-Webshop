    ...
    cartItems.forEach((item, index) => {
        ...
        itemElement.innerHTML = `
            ...
            <div class="flex items-center">
                ...
                <p class="mx-2 text-lg text-white">${item.quantity}</p>
            ...
            <div class="flex items-center">
                <p class="text-lg text-teal-400 font-bold">€${(item.price * item.quantity).toFixed(2)}</p>
                <button class="ml-4 bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 rounded-lg" onclick="removeFromCart(${index})">Remove</button>
            </div>
        `;
